...
> **当前下载：0.4.1 · build 15** · [查看发行说明](https://github.com/Lincb522/GLEVIO/releases/tag/v0.4.1)
...
这一版加入窗口尺寸、拖入添加和常用应用优先，并调整 Dock、启动及拖动行为。
...
当前包已完成通用构建与包校验；真实拖入安装、窗口缩放及 Dock 首次触边等新交互仍待验证，详见 [发行说明](https://github.com/Lincb522/GLEVIO/releases/tag/v0.4.1)。
